...
const val CategoryModifyTitle = "카테고리 수정"
...
const val UserNameTitle = "닉네임"
const val LogOut = "로그아웃"
const val LogOutDialogTitle = "로그아웃 하시겠어요?"
const val LogOutDialogBackBtn = "돌아가기"
const val LogOutDialogDoBtn = "로그아웃"
const val ServiceTitle = "서비스"
const val Notice = "공지사항"
const val FAQ = "문의 & FAQ"
const val Policy = "개인정보처리 방침"
const val PolicyTitle = "개인정보처리방침"
const val Version = "버전"
const val VersionSetting = "v %s"
const val UserDelete = "서비스 탈퇴하기"
const val UserDeleteTitle = "탈퇴하시는\n이유는 무엇인가요?"
const val UserDeleteContent = "답변해주신 내용을 바탕으로 더 좋은 서비스를\n만들기 위해 노력하겠습니다."
const val UserDeleteBtn = "탈퇴하기"
const val DeleteDialogTitle = "정말 탈퇴하시겠어요?"
const val DeleteDialogContent = "탈퇴 시 계정에 저장된 모든 데이터가\n삭제되며, 복구되지 않아요."
const val DeleteFinishTitle = "안녕히가세요, %s님!"
const val DeleteFinishContent = "사용해주셔서 감사합니다.\n더 좋은 서비스를 제공할 수 있도록\n노력하겠습니다."
const val NotUsed = "자주 사용하지 않아요"
const val MissingFeature = "원하는 기능이 없어요"
const val TooComplex = "과정이 너무 복잡해요"
const val DeleteReasonInputHint = "직접 입력..."
